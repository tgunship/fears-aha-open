...
# --- 1. 痛みリスト ---
DEFAULT_NEEDS = [
    "失敗", "枯渇・消耗", "未達成・敗北", "コントロール不可・予測不能", "無駄・報われない", 
    "暴走", "妥協", "停滞・閉塞", "無責任・不誠実", "キャパオーバー", 
    "老い・衰え", "搾取される・利用される", "対立・不調和", "依存", "誤解", 
    "不公平・理不尽", "人を傷つける・不快にする", "平凡", "制限される・支配される", "つまらない人間・つまらない人生", 
    "不要・役割の喪失", "自己崩壊", "本性の露呈・偽装の露呈", "期待外れ・ガッカリ", "異常・異物", 
    "批判・否定・認められない", "自分への嘘", "責められる・攻撃される", "忘却・埋没", "見下される・軽く見られる", 
    "粗末に扱われる", "無関心・放置", "嫉妬される", "分離・断絶", "領域を侵される・踏み込まれる", 
    "裏切り", "嫌われる・迷惑", "わかられない・受け取られない", "孤立・排除・拒嫌", "頼れない・助けてくれない", 
    "無価値", "絶望", "無力", "愛されない", "存在意義の喪失", 
    "存在の否定", "空っぽ", "見捨てられる・見切られる", "絶対的な孤独・隔絶", "魅力が無い・醜い", 
    "居場所の喪失", "できない・不十分・未熟", "欠陥・ポンコツ・劣等", "惨め", "ゆるされない・原罪感"
]
