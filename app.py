...
DEFAULT_NEEDS = [
    ...
    "枯渇・消耗", "コントロール不可", "暴走", "停滞・閉塞", "キャパオーバー", 
    "老い・衰え", "対立・不調和", "誤解", "傷つける・不快にする", "制限/支配される", 
    "搾取/利用される", "依存", "不公平・理不尽", "平凡", "つまらない人間/人生", 
    "不要・役割の喪失", "本性/偽装の露呈", "異常・異物", "自分への嘘", "忘却・埋没", 
    "自己崩壊", "期待外れ・ガッカリ", "認められない", "責められる", "軽く見られる", 
    "粗末に扱われる", "嫉妬される", "踏み込まれる", "嫌われる・迷惑", "排除・拒絶", 
    "無関心・放置", "分離・断絶", "裏切り", "わかられない", "頼れない", 
    "無価値", "無力", "存在意義の喪失", "空っぽ", "孤独", 
    "絶望", "愛されない", "存在の否定", "見捨てられる", "魅力が無い", 
