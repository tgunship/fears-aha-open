...
# --- 1. 怖れリスト ---
DEFAULT_NEEDS = [
    "失敗", "未達成・敗北", "無駄・報われない", "妥協", "無責任・不誠実", 
    "枯渇・消耗", "コントロール不可・予測不能", "暴走", "停滞・閉塞", "キャパオーバー", 
    "老い・衰え", "対立・不調和", "誤解", "人を傷つける・不快にする", "制限される・支配される", 
    "搾取される・利用される", "依存", "不公平・理不尽", "平凡", "つまらない人間・つまらない人生", 
    "不要・役割の喪失", "本性の露呈・偽装の露呈", "異常・異物", "自分への嘘", "忘却・埋没", 
    "自己崩壊", "期待外れ・ガッカリ", "批判・否定・認められない", "責められる・攻撃される", "見下される・軽く見られる", 
    "粗末に扱われる", "嫉妬される", "侵襲・踏み込まれる", "嫌われる・迷惑", "孤立・排除・拒絶", 
    "無関心・放置", "分離・断絶", "裏切り", "わかられない・受け取られない", "頼れない・助けてくれない", 
    "無価値", "無力", "存在意義の喪失", "空っぽ", "絶対的な孤独・隔絶", 
    "絶望", "愛されない", "存在の否定", "見捨てられる", "魅力が無い・醜い", 
