...
DEFAULT_NEEDS = [
    "第1階層：表面的な怖れ（日常の事象・結果・行動・状態レベルに対する怖れ）": {
        "A. 成果・行動に関する怖れ（結果が出ないこと）": [
            "失敗", "未達成・敗北", "無駄・報われない", "妥協", "無責任・不誠実", "枯渇・消耗"
        ],
        "B. 状況・状態のコントロールに関する怖れ（制御できないこと）": [
            "コントロール不可・予測不能", "暴走", "停滞・閉塞", "キャパオーバー", "老い・衰え"
        ],
        "C. 対人関係・環境に関する怖れ（他者との間に起きる摩擦）": [
            "対立・不調和", "誤解", "人を傷つける・不快にする", "制限される・支配される", "搾取される・利用される", "依存", "不公平・理不尽"
        ]
    },
    "第2階層：奥にある怖れ（他者からの評価・関係性・アイデンティティに対する怖れ）": {
        "A. 自己価値・アイデンティティの揺らぎ（「ダメなやつ」「普通」と思われること）": [
            "平凡", "つまらない人間・つまらない人生", "不要・役割の喪失", "本性の露呈・偽装の露呈", "異常・異物", "自分への嘘", "忘却・埋没", "自己崩壊"
        ],
        "B. 他者からのネガティブな評価・攻撃（否定やマウントをされること）": [
            "期待外れ・ガッカリ", "批判・否定・認められない", "責められる・攻撃される", "見下される・軽く見られる", "粗末に扱われる", "嫉妬される", "侵襲・踏み込まれる"
        ],
        "C. つながりの断絶・コミュニケーションの不全（関係性が切れること）": [
            "嫌われる・迷惑", "孤立・排除・拒絶", "無関心・放置", "分離・断絶", "裏切り", "わかられない・受け取られない", "頼れない・助けてくれない"
        ]
    },
    "第3階層：根源的な怖れ（存在・生命レベル / メンタルモデルの核となる怖れ）": {
        ...
        "B. 「ひとりぼっち」の核（つながりへの絶望）": [
            "絶対的な孤独・隔絶", "絶望"
        ],
        "C. 「愛なし」の核（受容への絶望）": [
            "愛されない", "存在の否定", "見捨てられる", "魅力が無い・醜い"
        ],
        "D. 「欠陥欠損」の核（完全性への絶望）": [
            "居場所の喪失", "できない・不十分・未熟", "欠陥・ポンコツ・劣等", "惨め", "許されない・原罪感"
        ]
    }
}
