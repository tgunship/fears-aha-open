...
# --- 1. 怖れリスト ---
DEFAULT_NEEDS = [
                                                                                          #【第1階層：表面的な怖れ】（日常の事象・結果・行動・状態レベルに対する怖れ）
    "失敗", "未達成・敗北", "無駄", "妥協", "無責任・不誠実",                                    #成果・行動に関する怖れ（結果が出ないこと）
    "コントロール不可・予測不能", "暴走", "停滞", "キャパオーバー", "老い・衰え",                  #状況・状態のコントロールに関する怖れ（制御できないこと）
    "対立", "誤解", "人を傷つける・不快にする", "制限される・支配される",                          #対人関係・環境に関する怖れ（他者との間に起きる摩擦）
    "搾取される・利用される", "依存", "不公平・理不尽",
                                                                                           #【第2階層：奥にある怖れ】（他者からの評価・関係性・アイデンティティに対する怖れ）
    "平凡", "つまらない人間・つまらない人生", "役割の喪失", "本性の露呈", "異端", "自分への嘘",      #自己価値・アイデンティティの揺らぎ（「ダメなやつ」「普通」と思われること）
    "期待外れ・ガッカリ", "批判・否定・認められない", "責められる", "攻撃される",                    #他者からのネガティブな評価・攻撃（否定やマウントをされること）
    "見下される・軽く見られる", "粗末に扱われる", "嫉妬される",
    "嫌われる", "孤立・仲間外れ", "無関心", "分離・断絶", "裏切り",                                #つながりの断絶・コミュニケーションの不全（関係性が切れること）
    "わかられない・受け取られない", "頼れない・助けてくれない", "報われない", "迷惑", 
                                                                                           #【第3階層：根源的な怖れ】（存在・生命レベル / メンタルモデルの核となる怖れ）
    "無価値", "無力", "存在意義の喪失",                                                          #「価値なし」の核（存在意義への絶望）
    "絶対的な孤独・隔絶", "居場所の喪失",                                                         #「ひとりぼっち」の核（つながりへの絶望）
    "愛されない", "存在の否定", "見捨てられる", "魅力が無い・醜い",                                 #「愛されない」の核（受容への絶望）
    "原罪感", "欠陥・不十分・未熟", "空っぽ", "自己崩壊", "カオス", "絶望", "惨め"                  #「欠陥欠損・自己喪失」の核（存在そのものへの絶望）
]

st.title("🎯 怖れアハ！")
# タイトルの直下に小さくバージョン情報を表示（margin-bottomを兄弟アプリと統一）
st.markdown("<div style='font-size: 14px; color: #888888; margin-top: -15px; margin-bottom: 10px;'>全てオープン版 Ver1.00</div>", unsafe_allow_html=True)
